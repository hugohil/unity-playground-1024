...
public class SelectiveOutlineRendererFeature : ScriptableRendererFeature {
    ...
    class SelectiveOutlinePass : ScriptableRenderPass {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData) {
            ...
            TextureHandle normals = UniversalRenderer.CreateRenderGraphTexture(renderGraph, desc, "_viewSpaceNormals", false);
            TextureHandle destination = UniversalRenderer.CreateRenderGraphTexture(renderGraph, desc, "_SelectiveOutlineTexture", false);
